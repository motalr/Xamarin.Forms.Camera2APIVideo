...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BSV.Droid.Camera2.CameraCaptureListener, BSV.Android", CameraCaptureListener.class, __md_methods);
	}
	...
	public CameraCaptureListener ()
	{
		...
		if (getClass () == CameraCaptureListener.class)
			mono.android.TypeManager.Activate ("BSV.Droid.Camera2.CameraCaptureListener, BSV.Android", "", this, new java.lang.Object[] {  });
	}
