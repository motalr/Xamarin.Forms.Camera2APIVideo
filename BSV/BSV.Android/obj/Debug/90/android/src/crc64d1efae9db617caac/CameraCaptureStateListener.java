...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BSV.Droid.Camera2.CameraCaptureStateListener, BSV.Android", CameraCaptureStateListener.class, __md_methods);
	}
	...
	public CameraCaptureStateListener ()
	{
		...
		if (getClass () == CameraCaptureStateListener.class)
			mono.android.TypeManager.Activate ("BSV.Droid.Camera2.CameraCaptureStateListener, BSV.Android", "", this, new java.lang.Object[] {  });
	}
